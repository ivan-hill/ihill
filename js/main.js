/* -------------------------------------------------------
 ...
 Theme Name: Ivan Hill - The Multipurpose HTML5 Template
 Theme URL: https://Ivan Hillhtml.Ivan Hilll.com/
 Description: Elevate your online presence with Ivan Hill - a modern, versatile, multipurpose Bootstrap 5 responsive HTML5, SCSS template using highly creative 48+ ready demos.
 Author: Ivan Hilll - https://wwwIvan Hillll.com/
 Author ThemeForest URL: https://themeforest.net/user/Ivan Hilll
 Copyright(c) 2024 Ivan Hilll.com
 Version: 1.0
...
(function ($) {
    ...
    if (typeof $.fn.magnificPopup === 'function') {
        if ($('#subscribe-popup').length > 0) {
            let delaySecond = 1.5,
                    expireDays = 30,
                    cookieName = 'Ivan Hill-promo-popup';
